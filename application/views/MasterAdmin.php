...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url()?>assets/css/meanmenu.min.csscss/jquery.mCustomScrollbar.min.css">
    ...
    <!-- End Style -->
    <script src="<?php echo base_url()?>asests/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-flask"></i> <span class="mini-dn">Referensi</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="google-map.html" class="dropdown-item">Jenis Produk</a>
                                <a href="data-maps.html" class="dropdown-item">Provinsi & Kab/Kota</a>
                                <a href="pdf-viewer.html" class="dropdown-item">Distrik & Kampung</a>
                            </div>
                        </li>
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-envelope"></i> <span class="mini-dn">Data Master</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="<?php echo base_url()?>Hasillaut" class="dropdown-item">Hasil Laut</a>
                                <a href="<?php echo base_url()?>Nelayan" class="dropdown-item">Nelayan</a>
                                <a href="<?php echo base_url()?>Produk" class="dropdown-item">Produk</a>
                            </div>
                        </li>

                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-pie-chart"></i> <span class="mini-dn">Transaksi</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="profile.html" class="dropdown-item">Pesanan</a>
                                <a href="contact-client.html" class="dropdown-item">Konfirmasi</a>
                                <a href="contact-client-v.1.html" class="dropdown-item">Pengantaran</a>
                                <a href="project-list.html" class="dropdown-item">Produk Terjual</a>
                            </div>
                        </li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demo" href="#">Data Master <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul id="demo" class="collapse dropdown-header-top">
                                                <li><a href="inbox.html">Hasil Laut</a>
                                                </li>
                                                <li><a href="view-mail.html">Nelayan</a>
                                                </li>
                                                <li><a href="compose-mail.html">Produk</a>
                                                </li>
                                            </ul>
                                        </li>
